...
- evt. noch zusätzlichi Posmo daten laden 
```{r}
# load all posmo data --------------------------------------- 
...
posmo <- posmo |>
  subset(dataset != "posmo4") |> # remove dataset 4 (because it has few data)
  select(-user_id)
...
posmo_timecut <- posmo |>
  filter(date = ifelse(datetime < "2023-04-22 00:00:00" & datetime > "2023-05-10 00:00:00", TRUE, FALSE)
                       
                       c("2023-04-11", "2023-04-12", "2023-04-14", "2023-04-10", "2023-04-13", "2023-04-15", "2023-04-17", "2023-04-20", "2023-04-21", "2023-04-19", "2023-04-01",  "2023-04-02",  "2023-04-03", "2023-04-04", "2023-04-05", "2023-04-06" ,"2023-04-07", "2023-04-08", "2023-04-09", "2023-04-16", "2023-04-18", "2023-05-14"))
...
# add convenience variable with date only (without time)
posmo <- posmo |> 
