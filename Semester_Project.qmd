...
# geht noch nicht 
posmo <- posmo |>
  mutate(day_week = ifelse(weekday == "Sat", "weekend", "weekday")) # so geht es, aber wenn ich zwei attribute nehmen will (also sa & so) dann geht es nicht...

# hier die codezeile die nicht funktioniert hat... 
 # mutate(day_week = ifelse(weekday == "Sat" & weekday == "Sun", "weekend", "weekday"))

# Unterscheidung Tag, Nacht (Tag: 06:00 – 22:00, Nacht: 22:00 – 06:00?) --------------

# geht noch nicht, hier ist das gleiche problem wie oben.... 
posmo <- posmo |>
