...
movement patterns of people. There are several study's investigating
...
impacted by age, income and life stage impacting travelling behaviour in
different ways (Kattiyapornpong & Miller, 2009). Because people with
...
3.  Does intense precipitation has an impact on the spatio-temporal
...
visualising distance, speed and duration per hour of the day comparing
weekends with weekdays were carried out. Cartographic maps visualising
...
compared to weekdays. Generally, the distance travelled by foot (tavel
mode: walk) had a lower mean than other travel modes. On the contrary it
is shown, that the mean distance travelled by bike is around the same
range a the travel modes car and train.
...
For trip speed there is a tendency of trip speed being higher on the
weekends than during the week except for the travel mode train, where
the relationship is reversed. Again we find the mean trip speed by bike
being in a similar range as when students travelled by car and train,
whereas the travel mode bus conforms to when students travelled by
horse.
...
The trip speed shows a decreasing trend of travel speed from around 4 AM
to 11 PM on the weekend days. Additionally, trip speed per hour mostly
is higher for weekends compared to weekdays. On weekdays the trip speed
per hour is relatively stable during the day (7 AM to 4 PM) with two
peaks at around 5 PM and 8 PM and a considerably lower speed at around 6
AM.
...
on the weekdays at around 8 PM the duration of trips was the highest.
Additionally, between 3 and 5 PM trip duration is considerably higher
than average during the weekend days, while at around 8 AM and 5 PM trip
duration during the week is higher compared to other hours of the day.
...
distance was higher for travel modes like train and tram. Rain does not
seem to have an effect on trip distance when travelling by horse.
Although, travel distances are impacted by precipitation, the effect can
...
Speed at high precipitation is lower when travelling by bike, foot, bus
and car, while for travel modes such as train and tram speed was higher.
Travelling by horse does not seem to be effected by precipitation.
Although, travel speeds are impacted by precipitation, the effect can be
...
students, where movement activity regarding trip distance and speed
generally is slightly higher on the weekends than during the weekdays.
...
transport during the weekdays are only slightly higher in distance,
speed and sometimes lower in duration, which could indicate, that other
...
al. (2018) found, that rain during the weekend has no key role on travel
modes, but heavy rain decreases the use of public transport during the
...
further decreases for trip duration, a reason could be our imbalanced
dataset. As we had to cut our datasets in time, to attain seamless data
over all days, from all individual participants, we ended up with 7 days
of the data for weekdays and only 4 days for weekends. This bias
potentially has impacted our results. For further studies we therefore
suggest a larger number of participants and a longer period of
GPS-tracking, to achieve a more balanced dataset.
...
Additionally, spatio-temporal movement during the week was more
balanced, with lower peaks of distance, speed and duration during the
day. In contrast to this on the weekends high peaks of distance, speed
and duration of trips were found early in the morning with a general
trend to decrease during the day, often times with regular peaks at
several hours.
...
prominent to more night hours, while vehicle use is more prominent
during daylight hours (Brum-Bastos et al., 2018). Additionally, more
time at home and less time shopping or socialising is spend during night
hours during the week while again, this relationship reverses on the
weekends (Brum-Bastos et al., 2018), which fits with our observations,
of a high peak of movement activity during 3 to 6 AM on the weekends, as
...
found to be more homogenous with lower peaks, fitting the expectation
that during typical commuting times (around 6 -- 8 AM and 3 -- 6 PM)
spatio-temporal movement behaviour increases in activity. An additional
peak for distance, speed and duration at around 8 PM during the weekdays
...
By foot it could be shown that speed and distance were lower under heavy
rain, while the duration was not impacted by precipitation patterns. In
contrast to our finding, Brum-Bastos et al. (2018) found an overall
decrease in walking during rain. It was shown, that when travel
destinations are obligatory (e.g., work, lectures) people change their
travel mode more likely under heavy rain, meaning that they drive to
work instead of walk. However, if destinations are linked to leisure
activities, people more likely just postpone the task instead of
changing their travel mode (Connolly, 2008). Additionally, during the
week a decrease in public transport was observed under heavy rain by
Brum-Bastos et al. (2018). This finding are in contrast to our results,
where the use of some public transport means (train and tram) was
increased under heavy rain, although we did not include the
...
Additionally, the results need to be interpreted with caution, as in
figure 13 it is shown, that for some trajectory points weather stations
are rather far away to serve as an indication for precipitation.
