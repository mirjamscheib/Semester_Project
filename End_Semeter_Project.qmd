...
Does the time of the day compared between weekend/weekday have an influence on spatio-temporal movement patterns of students?  

Does the weather condition (e.g. precipitation) have an impact the spatio-temporal patterns of students?  
...
```{r}
#| label: load clean data posmo trips
...
#| fig-cap: "Mean trip distance for every hour of the day on weekdays and weekends"
...
#| fig-cap: "Mean trip speed for every hour of the day on weekdays and weekends"
...
#| fig-cap: "Mean trip duration for every hour of the day on weekdays and weekends"
...
Does the weather condition (e.g. precipitation) have an impact on spatio-temporal patterns of students on different travel modes?

```{r}
#| label: load clean data again
posmo <- read_delim("posmo_data/posmo_trips.csv")
```
...
#| fig-cap: "Mean trip distance depending on precipitation status, where the trip distance is logarythmised"
...
#| fig-cap: "Mean trip speed depending on precipitation status, where the trip speed is logarythmised"
...
#| fig-cap: "Mean trip duration depending on precipitation status"
