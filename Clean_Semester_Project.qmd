...
posmo <- posmo |>
  subset(dataset != "posmo4" & dataset != "posmo7" & dataset != "posmo10") |>
...
posmo_timecut <- posmo |>
  filter(datetime >= "2023-04-22 00:00:00", 
         datetime < "2023-05-10 00:00:00")           

# look at the new timecut data - more consistent 
ggplot(posmo_timecut, aes(datetime, dataset))+
         geom_point()
```
