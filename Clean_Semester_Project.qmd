...
ggplot(posmo, aes(transport_mode, log(steplength), fill = rain_day)) +
  ...
  ylab("Log Steplength [m]") +
  xlab("Transport Mode") +
  scale_fill_manual(values = c("no_rain" = "red", "rain" = "blue"), labels = c( "Dry", "Rain")) +
  theme_minimal()
...
# mean trip duration looks odd, need to check that (!!)
ggplot() +
  geom_boxplot(data = posmo_trips, aes(transport_mode, trip_duration/60, fill = rain_day)) +
  labs(title = "Travelled Distance per Transport Mode", subtitle = "Comparing Rainy vs. Dry Days", fill = "Rain vs. Dry") +
  ylab("Duration [min]") +
  xlab("Transport Mode") +
  scale_fill_manual(values = c("no_rain" = "red", "rain" = "blue"), labels = c( "Dry", "Rain")) +
...
ggplot() +
  geom_boxplot(data = posmo_trips, aes(transport_mode, trip_dis, fill = rain_day)) +
    labs(title = "Speed per Transport Mode", subtitle = "Comparing Rainy vs. Dry Days", fill = "Rain vs. Dry") +
  ylab("Distance [m]") +
  xlab("Transport Mode") +
  scale_fill_manual(values = c("no_rain" = "red", "rain" = "blue"), labels = c( "Dry", "Rain")) +
